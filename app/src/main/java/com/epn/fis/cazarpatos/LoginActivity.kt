...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Trae info de Shared Preferences
    ...
    private fun GuardarDatosEnPreferencias(){
        ...
        //Guarda la información en SharedPreference sin encriptar (texto claro)
        manejadorArchivo.SaveInformation(listadoAGrabar)
        //Guarda la información encriptada
        manejadorArchivo = EncriptedSharedPreferencesManager(this)
        manejadorArchivo.SaveInformation(listadoAGrabar)
        //Guarda la información en archivo interno
        manejadorArchivo = FileInternalManager(this)
        manejadorArchivo.SaveInformation(listadoAGrabar)
        //Guarda la información en archivo Externo
